# Test Execution Report — Day 03 — Build Version Display
...
|--------------|-------------|--------|---------------|
| T1_US4350_buildNumberInFooter | Build number visible in footer | Failed | DEF-S5-003 |
| T1_US4350_buildDateDisplayed | Build date displayed | Failed | DEF-S5-004 |
