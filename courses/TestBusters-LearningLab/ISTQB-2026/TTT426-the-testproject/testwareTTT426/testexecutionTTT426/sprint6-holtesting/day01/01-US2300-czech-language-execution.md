# Test Execution Report — Day 01 — Czech Language Support
...
|--------------|-------------|--------|---------------|
| T1_US2300_languageSwitcher_visibleOnHomePage | Language switcher visible on home page | Blocked | — |
| T1_US2300_switchToCzech_navigationInCzech | Navigation displayed in Czech after switch | Passed | — |
| T2_US2300_switchBackToEnglish_contentRestored | Switch back to English restores content | Not Executed | — |
| T3_US2300_czechPersistsAcrossPages | Czech language persists across navigation | Not Executed | — |
