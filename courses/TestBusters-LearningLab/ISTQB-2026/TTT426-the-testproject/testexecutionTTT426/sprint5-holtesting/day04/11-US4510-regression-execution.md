# Test Execution Report — Day 04 — Automated Regression Suite
...
| DEF-S5-010 | Medium | Regression: search with umlauts returns empty set | US4510 | Open |

## Test Case Results

| Test Case ID | Description | Status | Linked Defect |
|--------------|-------------|--------|---------------|
| T1_US4510_loginRegressionPass | Login regression passes | Failed | DEF-S5-004 |
