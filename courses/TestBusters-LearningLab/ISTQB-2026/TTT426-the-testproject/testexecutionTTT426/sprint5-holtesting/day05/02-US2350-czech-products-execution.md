# Test Execution Report — Day 05 — Czech Product Content
...
|--------------|-------------|--------|---------------|
| T1_US2350_productTitleInCzech | Product title in Czech on detail page | Failed | DEF-S5-005 |
| T1_US2350_productDescriptionInCzech | Product description in Czech | Passed | — |
