# Test Execution Report — Day 03 — Czech Product Content
...
|--------------|-------------|--------|---------------|
| T1_US2350_productTitleInCzech | Product title in Czech on detail page | Failed | DEF-S5-003 |
| T1_US2350_productDescriptionInCzech | Product description in Czech | Failed | DEF-S5-004 |
