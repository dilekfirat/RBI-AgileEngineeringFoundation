# Test Execution Report — Day 01 — Delivery Options and Costs
...
|--------------|-------------|--------|---------------|
| T1_US4200_standardShownForAllRegions | Standard delivery shown for CZ, EU, US, Others | Not Executed | — |
| T1_US4200_zasilkovaShownForCZandDACH | Zásilkovna shown for CZ and DACH only | Not Executed | — |
| T4_US4200_zasilkovaHiddenForUS | Zásilkovna not shown for US shipping | Not Executed | — |
| T1_US4200_lightTierBelow10kg | Light tier applied below 10 kg | Not Executed | — |
| T1_US4200_heavyTierAt10kgOrMore | Heavy tier applied at 10 kg or more | Not Executed | — |
